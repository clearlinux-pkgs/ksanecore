...
Source0  : https://download.kde.org/stable/release-service/23.08.1/src/ksanecore-23.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.1/src/ksanecore-23.08.1.tar.xz.sig
...
%prep
%setup -q -n ksanecore-23.08.1
cd %{_builddir}/ksanecore-23.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695049612
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSaneCore.so.23.08.1
/usr/lib64/libKSaneCore.so.1
/usr/lib64/libKSaneCore.so.23.08.1
