...
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/ksanecore-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/ksanecore-23.04.2.tar.xz.sig
...
%prep
%setup -q -n ksanecore-23.04.2
cd %{_builddir}/ksanecore-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686498622
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSaneCore.so.23.04.2
/usr/lib64/libKSaneCore.so.1
/usr/lib64/libKSaneCore.so.23.04.2
