...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/ksanecore-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/ksanecore-24.05.2.tar.xz.sig
...
%setup -q -n ksanecore-24.05.2
cd %{_builddir}/ksanecore-24.05.2
pushd ..
cp -a ksanecore-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720534664
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSaneCore6.so.24.05.2
/usr/lib64/libKSaneCore6.so.1
/usr/lib64/libKSaneCore6.so.24.05.2
