...
Version  : 25.04.1
Release  : 40
URL      : https://download.kde.org/stable/release-service/25.04.1/src/ksanecore-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/ksanecore-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/ksanecore-25.04.1.tar.xz.sig
...
%setup -q -n ksanecore-25.04.1
cd %{_builddir}/ksanecore-25.04.1
pushd ..
cp -a ksanecore-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747072970
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSaneCore6.so.25.04.1
/usr/lib64/libKSaneCore6.so.1
/usr/lib64/libKSaneCore6.so.25.04.1
