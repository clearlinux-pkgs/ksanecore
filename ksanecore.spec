...
Version  : 22.08.0
Release  : 1
URL      : https://download.kde.org/stable/release-service/22.08.0/src/ksanecore-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/ksanecore-22.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.0/src/ksanecore-22.08.0.tar.xz.sig
...
%prep
%setup -q -n ksanecore-22.08.0
cd %{_builddir}/ksanecore-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661783280
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKSaneCore.so.22.08.0
