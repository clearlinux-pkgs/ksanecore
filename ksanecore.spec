...
Version  : 24.02.2
Release  : 24
URL      : https://download.kde.org/stable/release-service/24.02.2/src/ksanecore-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/ksanecore-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/ksanecore-24.02.2.tar.xz.sig
...
%prep
%setup -q -n ksanecore-24.02.2
cd %{_builddir}/ksanecore-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712855050
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSaneCore6.so.24.02.2
/usr/lib64/libKSaneCore6.so.1
/usr/lib64/libKSaneCore6.so.24.02.2
