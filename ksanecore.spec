...
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/ksanecore-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/ksanecore-24.02.1.tar.xz.sig
...
%prep
%setup -q -n ksanecore-24.02.1
cd %{_builddir}/ksanecore-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711029156
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSaneCore6.so.24.02.1
/usr/lib64/libKSaneCore6.so.1
/usr/lib64/libKSaneCore6.so.24.02.1
