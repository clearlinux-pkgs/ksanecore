...
Version  : 22.12.1
Release  : 6
URL      : https://download.kde.org/stable/release-service/22.12.1/src/ksanecore-22.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/ksanecore-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/ksanecore-22.12.1.tar.xz.sig
...
%prep
%setup -q -n ksanecore-22.12.1
cd %{_builddir}/ksanecore-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673277638
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKSaneCore.so.22.12.1
