...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/ksanecore-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/ksanecore-25.04.0.tar.xz.sig
...
%setup -q -n ksanecore-25.04.0
cd %{_builddir}/ksanecore-25.04.0
pushd ..
cp -a ksanecore-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744900147
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSaneCore6.so.25.04.0
/usr/lib64/libKSaneCore6.so.1
/usr/lib64/libKSaneCore6.so.25.04.0
